...
zips = []
dropbox_path = 'J:/code/knoss2obj/WebKnossos'
data_path = 'J:/code/knoss2obj/data'
obj_path = 'J:/code/knoss2obj/obj'
print('Starting matlab engine...')
eng = matlab.engine.start_matlab()

# Grab zipped raws from Dropbox, store in zips
print('Gathering zipped raw files...')
for root, dirnames, filenames in os.walk(dropbox_path):
